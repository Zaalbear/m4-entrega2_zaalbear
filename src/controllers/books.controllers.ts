...
export class BooksControllers {
    postBooks (req: Request, res: Response): Response {
        ...
        const newBook = bookService.postBooks(req.body.name, req.body.pages, req.body.category)
    ...
    updateBooks(req: Request, res: Response): Response{
        ...
        const response = bookService.updateBooks(req.params.id, req.body.name, req.body.pages, req.body.category);
